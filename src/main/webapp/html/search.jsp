...
<section id="products" class="section">
    <div class="container">
        ...
        <p>
            ...
            high-quality, nutrient-rich, nutritional products that <em>enhance active lifestyles</em>.
        </p>
        <%
    ...
    <div class="container">
        ...
        <div class="people-cards">
            <div class="person-card">
                <img src="images/employees/HenryTwill.jpg" alt="HenryTwill Photo" id="employees-henrytwill">
                <div class="card-info">
